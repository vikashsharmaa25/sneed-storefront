...
import { getBlogs } from '~/lib/api/content-management';
import { Calendar, Clock, BookOpen, ChevronRight, Tag } from 'lucide-react';
                ...
                <Container>
                    ...
                    {blogs.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {blogs.map((blog: any) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Image */}
                                        <Link to={`/blogs/${blog.id}`} className="relative h-48 overflow-hidden block bg-gray-50 border-b border-gray-100">
                                            <img
                                        ...
                                        <div className="p-6 flex-1 flex flex-col">
                                            ...
                                            <p className="text-gray-600 text-sm mb-6 line-clamp-3">
                                                {blog.excerpt || blog.content?.replace(/<[^>]*>/g, "").substring(0, 150) || "No description available"}
                                            </p>
                        ...
                        <div className="text-center py-20 bg-white rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <p className="text-gray-500">We couldn't find any blog posts at this moment. Please check back later.</p>
                        </div>
                    )}
                </Container>
            </div>
