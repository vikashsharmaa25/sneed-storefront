...
import { Mail, Lock, Eye, EyeOff, UserPlus, ShieldCheck, Truck, Clock, Loader2 } from 'lucide-react';
        ...
        <div>
          ...
          <div className="mt-20 space-y-6 max-w-lg">
            <h1 className="text-4xl font-extrabold tracking-tight leading-tight">
              Join Sneed Coding Solutions.
            </h1>
            <p className="text-red-100 text-lg">
              Create an account to gain full access to specialized coding consumables, fast reorders, and direct support.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left space-y-2">
            ...
            <p className="text-slate-500 text-sm">
              Get started with Sneed for your industrial coding needs
            </p>
          </div>
